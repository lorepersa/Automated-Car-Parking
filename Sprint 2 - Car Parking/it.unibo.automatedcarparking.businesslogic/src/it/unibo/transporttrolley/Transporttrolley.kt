		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="handleResumableMessages",cond=whenDispatch("transport_trolley_start"))
					transition(edgeName="t014",targetState="handleResumableMessages",cond=whenDispatch("transport_trolley_stop"))
					transition(edgeName="t015",targetState="handleNewJob",cond=whenRequestGuarded("transport_trolley_new_job",{ !status.stopped && !handling_job  
					}))
					transition(edgeName="t016",targetState="handleNewDestination",cond=whenRequestGuarded("transport_trolley_go_to",{ !status.stopped  
					}))
					transition(edgeName="t017",targetState="handleMoveReply",cond=whenDispatchGuarded("move_done",{ !status.stopped  
					}))
					transition(edgeName="t018",targetState="handleMoveReply",cond=whenDispatchGuarded("move_fail",{ !status.stopped  
					}))
					transition(edgeName="t019",targetState="convertStepReply",cond=whenReply("stepdone"))
					transition(edgeName="t020",targetState="convertStepReply",cond=whenReply("stepfail"))
					transition(edgeName="t021",targetState="handleCarTask",cond=whenRequestGuarded("transport_trolley_take_over_car",{ !status.stopped  
					}))
					transition(edgeName="t022",targetState="handleCarTask",cond=whenRequestGuarded("transport_trolley_release_car",{ !status.stopped  
					}))
					transition(edgeName="t023",targetState="handleJobDone",cond=whenDispatch("transport_trolley_job_done"))
					transition(edgeName="t024",targetState="handleGoHome",cond=whenDispatchGuarded("auto_transport_trolley_go_home",{ !status.stopped  
					}))
				}	 
