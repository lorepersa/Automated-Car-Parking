		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t037",targetState="handleResumableMessages",cond=whenDispatch("transport_trolley_start"))
					transition(edgeName="t038",targetState="handleResumableMessages",cond=whenDispatch("transport_trolley_stop"))
					transition(edgeName="t039",targetState="handleNewJob",cond=whenRequestGuarded("transport_trolley_new_job",{ !status.stopped && !handling_job  
					}))
					transition(edgeName="t040",targetState="handleNewDestination",cond=whenRequestGuarded("transport_trolley_go_to",{ !status.stopped  
					}))
					transition(edgeName="t041",targetState="handleMoveReply",cond=whenDispatchGuarded("move_done",{ !status.stopped  
					}))
					transition(edgeName="t042",targetState="handleMoveReply",cond=whenDispatchGuarded("move_fail",{ !status.stopped  
					}))
					transition(edgeName="t043",targetState="convertStepReply",cond=whenReply("stepdone"))
					transition(edgeName="t044",targetState="convertStepReply",cond=whenReply("stepfail"))
					transition(edgeName="t045",targetState="handleCarTask",cond=whenRequestGuarded("transport_trolley_take_over_car",{ !status.stopped  
					}))
					transition(edgeName="t046",targetState="handleCarTask",cond=whenRequestGuarded("transport_trolley_release_car",{ !status.stopped  
					}))
					transition(edgeName="t047",targetState="handleJobDone",cond=whenDispatch("transport_trolley_job_done"))
					transition(edgeName="t048",targetState="handleGoHome",cond=whenDispatchGuarded("auto_transport_trolley_go_home",{ !status.stopped  
					}))
				}	 
