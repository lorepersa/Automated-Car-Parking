		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t043",targetState="handleManagerRequest",cond=whenRequest("req_manager_fan_automatic_mode"))
					transition(edgeName="t044",targetState="handleManagerRequest",cond=whenRequest("req_manager_fan_manual_mode"))
					transition(edgeName="t045",targetState="handleManagerRequest",cond=whenRequest("req_manager_fan_on"))
					transition(edgeName="t046",targetState="handleManagerRequest",cond=whenRequest("req_manager_fan_off"))
					transition(edgeName="t047",targetState="handleModeFanUpdate",cond=whenEvent("mode_fan_automatic"))
					transition(edgeName="t048",targetState="handleModeFanUpdate",cond=whenEvent("mode_fan_manual"))
					transition(edgeName="t049",targetState="handleStatusFanUpdate",cond=whenEvent("state_fan_on"))
					transition(edgeName="t050",targetState="handleStatusFanUpdate",cond=whenEvent("state_fan_off"))
					transition(edgeName="t051",targetState="handleStatusIndoorArea",cond=whenEvent("indoor_area_free"))
					transition(edgeName="t052",targetState="handleStatusIndoorArea",cond=whenEvent("indoor_area_occupied"))
					transition(edgeName="t053",targetState="handleStatusOutdoorArea",cond=whenEvent("outdoor_area_free"))
					transition(edgeName="t054",targetState="handleStatusOutdoorArea",cond=whenEvent("outdoor_area_occupied"))
					transition(edgeName="t055",targetState="handleStatusParkingSlots",cond=whenEvent("status_parking_slots"))
					transition(edgeName="t056",targetState="handleStatusTransportTrolley",cond=whenEvent("transport_trolley_new_state"))
					transition(edgeName="t057",targetState="handleStatusTemperature",cond=whenEvent("temperature"))
				}	 
