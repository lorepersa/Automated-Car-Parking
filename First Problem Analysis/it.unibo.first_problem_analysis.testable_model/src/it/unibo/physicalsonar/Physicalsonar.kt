		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					action { //it:State
						...
						updateResourceRep( "distance(100.0)"  
						)
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t04",targetState="wait",cond=whenDispatch("input_distance"))
					transition(edgeName="t05",targetState="init",cond=whenRequest("setup"))
				}	 
			}
		}
}
