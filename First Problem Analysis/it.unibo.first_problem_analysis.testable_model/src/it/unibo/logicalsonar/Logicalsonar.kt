		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					action { //it:State
						...
						updateResourceRep( "outdoor_area(FREE)"  
						)
					...
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("distance(D)"), Term.createTerm("distance(D)"), 
								...
								updateResourceRep( "outdoor_area(FREE)"  
								 ...
								 updateResourceRep( "outdoor_area(OCCUPIED)"  
								 )
								 }
								 }
						}
					 ...
					 transition(edgeName="t_distance_filter6",targetState="handleDistanceEvent",cond=whenEvent("distance"))
					transition(edgeName="t_distance_filter7",targetState="init",cond=whenRequest("setup"))
				}	 
			}
		}
}
