	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("running") { //this:State
					...
					transition(edgeName="t044",targetState="sendTokenId",cond=whenEventGuarded("transport_trolley_position_indoor",{ car_park_request  
					}))
					transition(edgeName="t045",targetState="carParkDone",cond=whenEventGuarded("transport_trolley_position_slotnum",{ car_park_request  
					}))
					...
					transition(edgeName="t049",targetState="pickUpCarFinished",cond=whenEventGuarded("transport_trolley_position_outdoor",{ car_pickup_request  
					}))
